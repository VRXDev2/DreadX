...
FreecamToggled.RichText = true
FreecamToggled.Text = "<b>OFF</b>"
...
TotemESPToggled.RichText = true
TotemESPToggled.Text = "<b>OFF</b>"
...
OreESPToggled.RichText = true
OreESPToggled.Text = "<b>ON</b>"
